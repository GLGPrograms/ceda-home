...
<figure>
<img src="../assets/ceda/ceda.jpg" width="400" />
<span>Our Sanco 8003 at its first power on
</figure>
...
<figure>
<img src="../assets/ceda/psu-connector.jpeg" width="400px" />
...
## Motherboard
<figure>
<img src="../assets/ceda/sanco-mobo-picture.jpeg" width="200px" />
Motherboard of the Sanco 8003
</figure>
...
[PDF](../assets/ceda/sanco-mobo.pdf)

## Connectors
<figure>
<img src="../assets/ceda/incrt.png" width="200" />
Display connector. Computer's monitor is connected here, and is only accessible from inside the computer.
</figure>
...
| C13 | jumper (3x2) | SIO clock | serial clock | [PNG](../assets/ceda/sioclock.png) |


## ROM
| Name | Version | Type | Position | Size | MD5 hash | Binary |
| ---- | ------- | ---- | -------- | ---- | -------- | ------ |
| Software ROM | V1.01 | 2764 | H4-H5-H6 | 8kBytes | f33347faf867be9eea28d928c7341f0e | [BIN](../assets/ceda/v1.01_rom.bin) |
| Character ROM | CGV7.2 | 2732 | H12-H13-H14 | 4kBytes | 0bf03ecb77e3c6d220a354fe2c95fccd | [BIN](../assets/ceda/cgv7.2_rom.bin) |
| Glue ROM |  | TBP28L22 | J12 | 256 bytes | 69cf560a785ba0cd01427626949cc0a0 | [BIN](../assets/ceda/28l22.bin) |
...
<figure>
<img src="../assets/ceda/char-bitmap.png" width="200" >
Format of one character in the ROM.
</figure>

<figure>
<img src="../assets/ceda/character-rom-image.png" width="200" >
Full decode of CGV character ROM.
</figure>
...
- [VSYNC](../assets/ceda/vsync-0.png)
- [VSYNC detail](../assets/ceda/vsync-1.png)
- [HSYNC](../assets/ceda/hsync-0.png)
- [HSYNC detail](../assets/ceda/hsync-1.png)
- [Back Porch](../assets/ceda/backporch.png)

<figure>
<img src="../assets/ceda/vsync-1.png" width="400" />
A detail of vertical sync pulse.
</figure>
